 ...
 */
final readonly class TransferFlags implements \Stringable
{
	/**
	...
	public static function of(int $value): self
	{
		...
		if ($instance->isPostPending() && $instance->isVoidPending()) {
			throw ConstraintViolation::mutuallyExclusiveFlags('POST_PENDING', 'VOID_PENDING');
		}

		// POST_PENDING and VOID_PENDING cannot be combined with balancing flags
		if (
			($instance->isPostPending() || $instance->isVoidPending())
