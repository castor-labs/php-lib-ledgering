...
final readonly class Loan
{
	private function __construct(
		public Identifier $revenueId,
		public Identifier $customerCashId,
		public Identifier $principalId,
		public Identifier $feesId,
		public Identifier $interestId,
		public Identifier $overpaymentId,
		public Identifier $controlAccountId,
	) {}
	...
	public static function setup(Ledger $ledger, int $ledgerId = 1): self
	{
		...
		$ledger->execute(
			...
			CreateAccount::with(id: $revenueId, ledger: $ledgerId, code: 500),
			// Customer cash account (Liability) - customer's funds (tracking only)
			CreateAccount::with(id: $customerCashId, ledger: $ledgerId, code: 100),
			...
			CreateAccount::with(id: $overpaymentId, ledger: $ledgerId, code: 400),
			// Control account - temporary holding for repayment
			CreateAccount::with(id: $controlAccountId, ledger: $ledgerId, code: 900),
		);
