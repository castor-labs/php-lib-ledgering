...
final class TransferRepositoryTest extends TestCase
{
	...
	public function it_converts_to_list_map(): void
	{
		...
		$transfer1 = $this->createTransfer(Identifier::random(), ledger: Code::of(1), groupId: $groupId);
		$transfer2 = $this->createTransfer(Identifier::random(), ledger: Code::of(1), groupId: $groupId);
		$transfer3 = $this->createTransfer(Identifier::random(), ledger: Code::of(2), groupId: $groupId);
		...
		$map = $repository
			->ofExternalIdPrimary($groupId)
			->toListMap(static fn(Transfer $t) => (string) $t->ledger->value);
